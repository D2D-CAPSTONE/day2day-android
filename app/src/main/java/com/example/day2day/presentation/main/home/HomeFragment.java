...
public class HomeFragment extends Fragment {
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    View nearbyCourseCard = view.findViewById(R.id.btn_nearby_course);
    View locationCourseCard = view.findViewById(R.id.btn_location_course);

    nearbyCourseCard.setOnClickListener(
        v -> startActivity(new Intent(requireContext(), MapSelectionActivity.class)));
    locationCourseCard.setOnClickListener(
